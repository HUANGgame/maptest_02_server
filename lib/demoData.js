...
const kAreaPlaces = [
  ["k-area-k12", "K12", "樓梯", "k-area-airport-1f", 70, 300],
  ["k-area-west-plaza", "西廣場", "廣場", "k-area-airport-1f", 185, 335],
  ["k-area-k11", "K11", "樓梯", "k-area-airport-1f", 350, 340],
  ["k-area-k10", "K10", "樓梯", "k-area-airport-1f", 575, 455],
  ["k-area-k9", "K9", "樓梯", "k-area-airport-1f", 590, 345],
  ["k-area-central-plaza", "中央廣場", "廣場", "k-area-airport-1f", 870, 320],
  ["k-area-k7", "K7", "電梯", "k-area-airport-1f", 1035, 135],
  ["k-area-k6", "K6", "樓梯", "k-area-airport-1f", 1015, 350],
  ["k-area-k5", "K5", "樓梯", "k-area-airport-1f", 1225, 515],
  ["k-area-k4", "K4", "樓梯", "k-area-airport-1f", 1250, 350],
  ["k-area-k3", "K3", "樓梯", "k-area-airport-1f", 1450, 350],
  ["k-area-east-plaza", "東廣場", "廣場", "k-area-airport-1f", 1535, 335],
  ["k-area-k2", "K2", "樓梯", "k-area-airport-1f", 1705, 535],
  ["k-area-k1-east", "K1 東側", "樓梯", "k-area-airport-1f", 1710, 260],
  ["k-area-k1-north", "K1 北側", "電梯", "k-area-airport-1f", 1585, 135],
  ["k-area-airport-k12", "2F K12", "樓梯", "k-area-airport-2f", 90, 310],
  ["k-area-airport-corridor", "往桃園機場捷運", "出口", "k-area-airport-2f", 340, 70],
  ["k-area-airport-escalator", "2F 右側手扶梯", "手扶梯", "k-area-airport-2f", 880, 210],
];

places.push(
  ...kAreaPlaces.map(([id, name, category, floorId, x, y]) => ({
    id,
    ...
    x,
    y,
    description: "依 K 區地下街往機捷地圖建立的可導航地點。",
    searchable: true,
    businessStatus: "unset",
  }))
);

const kAreaRouteNodes = [
  ["k-node-k12", "k-area-airport-1f", 70, 300, "stairs"],
  ["k-node-west-plaza", "k-area-airport-1f", 185, 335, "walkway"],
  ["k-node-west-south", "k-area-airport-1f", 210, 515, "walkway"],
  ["k-node-k11", "k-area-airport-1f", 350, 340, "stairs"],
  ["k-node-k10", "k-area-airport-1f", 575, 455, "stairs"],
  ["k-node-k9", "k-area-airport-1f", 590, 345, "stairs"],
  ["k-node-central", "k-area-airport-1f", 870, 320, "walkway"],
  ["k-node-k7", "k-area-airport-1f", 1035, 135, "elevator"],
  ["k-node-k6", "k-area-airport-1f", 1015, 350, "stairs"],
  ["k-node-k5", "k-area-airport-1f", 1225, 515, "stairs"],
  ["k-node-k4", "k-area-airport-1f", 1250, 350, "stairs"],
  ["k-node-k3", "k-area-airport-1f", 1450, 350, "stairs"],
  ["k-node-east-plaza", "k-area-airport-1f", 1535, 335, "walkway"],
  ["k-node-k2", "k-area-airport-1f", 1705, 535, "stairs"],
  ["k-node-k1-east", "k-area-airport-1f", 1710, 260, "stairs"],
  ["k-node-k1-north", "k-area-airport-1f", 1585, 135, "elevator"],
  ["k-node-2f-k12", "k-area-airport-2f", 90, 310, "stairs"],
  ["k-node-2f-left", "k-area-airport-2f", 130, 70, "walkway"],
  ["k-node-2f-middle", "k-area-airport-2f", 520, 70, "walkway"],
  ["k-node-2f-escalator", "k-area-airport-2f", 880, 210, "escalator"],
];

routeNodes.push(
  ...kAreaRouteNodes.map(([id, floorId, x, y, nodeType]) => ({
    id,
    mapId: "k-area-airport",
    floorId,
    x,
...
const kAreaRouteEdges = [
  ["k-edge-k12-west", "k-area-airport-1f", "k-node-k12", "k-node-west-plaza"],
  ["k-edge-west-south", "k-area-airport-1f", "k-node-west-plaza", "k-node-west-south"],
  ["k-edge-west-k11", "k-area-airport-1f", "k-node-west-plaza", "k-node-k11"],
  ["k-edge-k11-k9", "k-area-airport-1f", "k-node-k11", "k-node-k9"],
  ["k-edge-k9-central", "k-area-airport-1f", "k-node-k9", "k-node-central"],
  ["k-edge-westsouth-k10", "k-area-airport-1f", "k-node-west-south", "k-node-k10"],
  ["k-edge-k10-central", "k-area-airport-1f", "k-node-k10", "k-node-central"],
  ["k-edge-central-k7", "k-area-airport-1f", "k-node-central", "k-node-k7"],
  ["k-edge-central-k6", "k-area-airport-1f", "k-node-central", "k-node-k6"],
  ["k-edge-k6-k4", "k-area-airport-1f", "k-node-k6", "k-node-k4"],
  ["k-edge-k4-k3", "k-area-airport-1f", "k-node-k4", "k-node-k3"],
  ["k-edge-k3-east", "k-area-airport-1f", "k-node-k3", "k-node-east-plaza"],
  ["k-edge-east-k1-east", "k-area-airport-1f", "k-node-east-plaza", "k-node-k1-east"],
  ["k-edge-east-k1-north", "k-area-airport-1f", "k-node-east-plaza", "k-node-k1-north"],
  ["k-edge-east-k2", "k-area-airport-1f", "k-node-east-plaza", "k-node-k2"],
  ["k-edge-central-k5", "k-area-airport-1f", "k-node-central", "k-node-k5"],
  ["k-edge-2f-k12-left", "k-area-airport-2f", "k-node-2f-k12", "k-node-2f-left"],
  ["k-edge-2f-left-middle", "k-area-airport-2f", "k-node-2f-left", "k-node-2f-middle"],
  ["k-edge-2f-middle-escalator", "k-area-airport-2f", "k-node-2f-middle", "k-node-2f-escalator"],
];

routeEdges.push(
  ...kAreaRouteEdges.map(([id, floorId, fromNodeId, toNodeId]) => {
    const from = kAreaRouteNodes.find(([nodeId]) => nodeId === fromNodeId);
    const to = kAreaRouteNodes.find(([nodeId]) => nodeId === toNodeId);
    return {
      id,
      mapId: "k-area-airport",
      floorId,
      fromNodeId,
      toNodeId,
      distance: Math.round(Math.hypot(from[2] - to[2], from[3] - to[3])),
      isBlocked: false,
    };
  })
);
...
floorTransitions.push(
  { id: "k-area-transition-k12-up", mapId: "k-area-airport", fromFloorId: "k-area-airport-1f", toFloorId: "k-area-airport-2f", fromNodeId: "k-node-k12", toNodeId: "k-node-2f-k12", transitionType: "stairs", name: "K12 樓梯" },
  { id: "k-area-transition-k12-down", mapId: "k-area-airport", fromFloorId: "k-area-airport-2f", toFloorId: "k-area-airport-1f", fromNodeId: "k-node-2f-k12", toNodeId: "k-node-k12", transitionType: "stairs", name: "K12 樓梯" }
);
