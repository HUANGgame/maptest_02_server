...
function createPlace(body) {
  ...
  const record = {
    ...
    routeNodeId: String(body.routeNodeId || "").trim(),
    nodeType: String(body.nodeType || "").trim(),
    isTransitionConnector: body.isTransitionConnector === true,
    transitionTargetValue: String(body.transitionTargetValue || "").trim(),
    transitionTargetNodeId: String(body.transitionTargetNodeId || "").trim(),
    transitionType: String(body.transitionType || "").trim(),
    isNavigationNode: body.isNavigationNode !== false,
